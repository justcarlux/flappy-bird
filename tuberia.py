...
class Tuberia(pygame.sprite.Sprite):
    def __init__(self, x, espacio, imagen): 
        super().__init__() 
        # La imagen ya viene como Surface desde el main, aquí creamos la versión invertida
        ...
        # Definición de rectángulos (Lógica original)
    ...
    def update(self):
        # Mantenemos tu lógica de movimiento
        self.tubo_abajo.x -= 2
        self.tubo_arriba.x -= 2

    def draw(self, pantalla):
        # Dibujamos las Surfaces pre-calculadas
